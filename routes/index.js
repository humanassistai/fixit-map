...
router.get('/', function(req, res) {
    var url = 'https://seeclickfix.com/api/v2/issues?place_url=deu_berlin&per_page=10&page=1'
...
router.get('/:city/:id', function(req, res) {
    ...
    var url = "https://seeclickfix.com/api/v2/issues?place_url=deu_berlin&&per_page=10&page=" + id;
